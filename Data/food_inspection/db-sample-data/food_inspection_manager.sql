...
VALUES ('food_inspection_metro', '{#2196F3,#E53935}', '{DistrictChart,ColumnChart}', '家')
...
(
    ...
    NULL,
    NULL,
    '{"circle-color":["match",["get","result"],"檢驗","#4DB464","未檢驗","#E53935","#9E9E9E"],"circle-radius":6,"circle-opacity":0.85,"circle-stroke-width":1,"circle-stroke-color":"#ffffff"}',
...
(
    ...
    'static', NULL, 0, '',
    '政府資料開放平台',
    '顯示臺北市食品業者抽驗紀錄，依行政區與抽驗結果（檢驗/未檢驗）統計。',
    '整合臺北市食品稽查及餐飲衛生分級評核資料，呈現各業者的食安抽驗履歷與結果。',
    '可協助衛生局掌握各行政區食品業者抽驗情況，作為食安稽查資源分配依據，並提供民眾查詢食安紀錄。',
    '{https://data.gov.tw}',
    '{doit}',
    NOW(), NOW(),
    'three_d',
...
(
    ...
    'static', NULL, 0, '',
    '政府資料開放平台',
    '顯示雙北地區食品業者抽驗紀錄，依行政區與抽驗結果（檢驗/未檢驗）統計。',
    '整合新北市抽驗（販售端/製造端）、餐飲衛生分級評核、第二級品管驗證及臺北市稽查等多來源資料，呈現雙北食品業者食安履歷。',
    '可協助雙北衛生局共同掌握各行政區食品業者抽驗情況，提升大台北地區食品安全管理水準，並提供民眾查詢食安紀錄。',
    '{https://data.gov.tw}',
    '{doit}',
    NOW(), NOW(),
    'three_d',
